...
export default function Thumbnail() {
    ...
    const currentThumbnailList = thumbnailList.find(q => q.region === params.regionCompanyID && q.productType === params.productType)

    const renderThumbnailList = currentThumbnailList?currentThumbnailList.results.map(item =>(
    ...
    function handleImageClick(e) {
        ...
        navigate(`/region-company/${params.regionCompanyID}/${params.productType}/${e.target.dataset.target}/`)
        console.groupEnd()
    }
